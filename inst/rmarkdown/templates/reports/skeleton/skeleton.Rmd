...
```{r plot-historic-data, include=TRUE, fig.height=6, fig.width=8, fig.cap= paste0("Circulación de virus respiratorios por período epidemiológico Año 2022 - ", params$year, " Laboratorio de Salud Pública de Bogotá.")}
#PLOTTING Figura 1

...
```{r, include=FALSE}
source("C:/Users/willa/GITHUB/labrep/R/checking_data.R", local = knitr::knit_global())
source("C:/Users/willa/GITHUB/labrep/R/import_data.R", local = knitr::knit_global())
source("C:/Users/willa/GITHUB/labrep/R/plotting_data.R", local = knitr::knit_global())
source("C:/Users/willa/GITHUB/labrep/R/cleaning_data.R", local = knitr::knit_global())
source("C:/Users/willa/GITHUB/labrep/R/utils.R", local = knitr::knit_global())
```
...
tabla <- clean_historic_data_temp(df = tabla)
...
plot_historic_epi_time_temp(df= tabla,periodo_epi = 3 )
```

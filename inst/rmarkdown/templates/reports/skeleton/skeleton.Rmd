...
```{r filmarray-data}
filmarray_data <- import_data_viral_circulation(report_data = c("C:/Users/geral/Documents/TRACE/labrep/data/FILMARRAY RESPIRATORIO.xlsx"),
                                                sheet = 1,
                                                skip = 3)
...
other_viruses_data <-
  import_data_viral_circulation(report_data =
                                  c("C:/Users/geral/Documents/TRACE/labrep/data/OTROSVIRUS_SE 23.xlsx"),
                                skip = 0,
                                sheet = 1)
...
```{r sars-data}
#sars_data <- import_data_viral_circulation(report_data = #c("C:/Users/geral/Documents/TRACE/labrep/data/df_other_virus_202252.cs#v"), header = TRUE)
...
#viruses_epiweeks <- get_distribution_epiweek(report_data = report_data_clean)
#other_viruses_epiweek <- 
#sars_cumulative_proportion <- get_viruses_cumulative_proportion(viruses_age_group,                                                               test_distribution_epiweek)
...
plot_cumulative_proportion(viruses_prop_epiweek$cases_epiweek)
```

En  la circulación viral estuvo con predominio de VSR (22.1%), Rinovirus (10.0%) y Adenovirus (6.0%); en las `r viruses_prop_epiweek$total_samples` muestras analizadas para esta semana.

TODO

Dentro de la circulación viral acumulada a params$epiweek al incluir el virus de SARS CoV 2 en la distribución de los virus respiratorios, se observa que predominan los Rinovirus (22%), SARS Cov2 (20%), y VSR (19%) de las 3.367 muestras positivas de las 14.394 muestras analizadas (figura 7).
...
#TODO Comentar acerca del cambio

En cuanto al comportamiento de los virus de Influenza acumulado a SE params$epiweek como de costumbre en las primeras semanas del año ha circulado el virus de Influenza A (2.9%), el virus de la Influenza A(H1N1) pdm09 (65.8%) e Influenza A(H3) (26.0%) en `r total_cases_influenza` muestras positivas. (Figura 8)
...
```{r tosferina-data}
tosferina_data <- import_data_viral_circulation(report_data = c("C:/Users/geral/Documents/TRACE/labrep/data/tosferina SE23.xlsx"), sheet = 1,
                                                col_names = TRUE)
tosferina_data <- readxl::read_excel("C:/Users/geral/Documents/TRACE/labrep/data/tosferina SE23.xlsx")
```
...
```{r distribution_tosferina_sex, include=TRUE, fig.height=6, fig.width=10, fig.cap="Distribución porcentual de casos de tosferina confirmados en el Laboratorio de Salud Pública, según género"}

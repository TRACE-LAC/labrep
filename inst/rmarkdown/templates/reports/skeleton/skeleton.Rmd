...
En `r params$epiweek` la circulación viral estuvo con predominio de `r viruses_prop_text`; en las `r viruses_prop_epiweek$total_samples` muestras analizadas para esta semana.
